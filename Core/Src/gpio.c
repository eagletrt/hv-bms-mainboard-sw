...
bit_flag32_t gpio_feedback_read_all(void) {
    ...
    feedbacks = MAINBOARD_BIT_TOGGLE_IF(feedbacks, HAL_GPIO_ReadPin(IMPLAUSIBLE_STATE_LATCHED_GPIO_Port, IMPLAUSIBLE_STATE_LATCHED_Pin) == GPIO_PIN_SET, FEEDBACK_DIGITAL_BIT_IMPLAUSIBLE_STATE_LATCHED);
