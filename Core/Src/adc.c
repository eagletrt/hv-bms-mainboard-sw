...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = COOLING_CONSUMPTION_Pin|ITS_HC_F_Pin|ITS_LC_F_Pin|AUX_TEMP_Pin
                          |OUTLET_LIQUID_TEMP_3_Pin|OUTLET_LIQUID_TEMP_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SD_OUT_Pin|SD_IN_Pin|SD_END_Pin|V5_MCU_Pin
                          |INLET_LIQUID_TEMP_Pin|OUTLET_LIQUID_TEMP_1_Pin|OUTLET_LIQUID_TEMP_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PF10     ------> ADC3_IN8
    */
    GPIO_InitStruct.Pin = AIRN_OPEN_MEC_Pin|AIRP_OPEN_MEC_Pin|IMD_OK_Pin|PLAUSIBLE_STATE_RC_Pin
                          |TSAL_GREEN_Pin|AMB_TEMP_Pin|PROBING_3V3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, COOLING_CONSUMPTION_Pin|ITS_HC_F_Pin|ITS_LC_F_Pin|AUX_TEMP_Pin
                          |OUTLET_LIQUID_TEMP_3_Pin|OUTLET_LIQUID_TEMP_4_Pin);

    HAL_GPIO_DeInit(GPIOA, SD_OUT_Pin|SD_IN_Pin|SD_END_Pin|V5_MCU_Pin
                          |INLET_LIQUID_TEMP_Pin|OUTLET_LIQUID_TEMP_1_Pin|OUTLET_LIQUID_TEMP_2_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF10     ------> ADC3_IN8
    */
    HAL_GPIO_DeInit(GPIOF, AIRN_OPEN_MEC_Pin|AIRP_OPEN_MEC_Pin|IMD_OK_Pin|PLAUSIBLE_STATE_RC_Pin
                          |TSAL_GREEN_Pin|AMB_TEMP_Pin|PROBING_3V3_Pin);
