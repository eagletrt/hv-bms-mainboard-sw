...
transition_func_t *const fsm_transition_table[FSM_NUM_STATES][FSM_NUM_STATES] = {
  ...
  /* init            */ {NULL                     , fsm_start                , fsm_handle_fatal_error   , NULL                     , NULL                     , NULL                     , NULL                     , NULL                     , NULL                     }, 
...
// This function is called in 8 transitions:
// 1. from init to fatal
// 2. from idle to fatal
// 3. from flash to fatal
// 4. from balancing to fatal
// 5. from airn_check to fatal
// 6. from precharge_check to fatal
// 7. from airp_check to fatal
// 8. from ts_on to fatal
