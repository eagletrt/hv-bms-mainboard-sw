...
_STATIC _InternalVoltageHandler internal_volt_handler;

InternalVoltageReturnCode
internal_voltage_init(spi_send_callback_t send,
...
primary_hv_ts_voltage_converted_t *
internal_voltage_get_ts_voltage_canlib_payload(size_t *const byte_size) {
    if (byte_size != NULL)
