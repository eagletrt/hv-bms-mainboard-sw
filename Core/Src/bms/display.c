...
DisplayReturnCode display_init(const display_segment_set_state_callback_t set, const display_segment_toggle_state_callback_t toggle) {
    ...
    tdsr0760_api_init(&hdisplay.tdsr0760);
    return DISPLAY_OK;
}
...
DisplayCharacterCode display_get_code_from_hex_digit(const uint8_t digit) {
    switch (digit) {
        case 0U:
            return DISPLAY_CHARACTER_CODE_0;
        case 1U:
            return DISPLAY_CHARACTER_CODE_1;
        case 2U:
            return DISPLAY_CHARACTER_CODE_2;
        case 3U:
            return DISPLAY_CHARACTER_CODE_3;
        case 4U:
            return DISPLAY_CHARACTER_CODE_4;
        case 5U:
            return DISPLAY_CHARACTER_CODE_5;
        case 6U:
            return DISPLAY_CHARACTER_CODE_6;
        case 7U:
            return DISPLAY_CHARACTER_CODE_7;
        case 8U:
            return DISPLAY_CHARACTER_CODE_8;
        case 9U:
            return DISPLAY_CHARACTER_CODE_9;
        case 10U:
