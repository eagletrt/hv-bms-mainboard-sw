...
#define IMPLAUSIBLE_STATE_LATCHED_Pin GPIO_PIN_4
#define IMPLAUSIBLE_STATE_LATCHED_GPIO_Port GPIOD
...
#define IMD_FAULT_COCKPID_LED_Pin GPIO_PIN_10
#define IMD_FAULT_COCKPID_LED_GPIO_Port GPIOG
#define BMS_FAULT_COCKPID_LED_Pin GPIO_PIN_11
#define BMS_FAULT_COCKPID_LED_GPIO_Port GPIOG
