...
#define pcu_api_reset_all() EAGLETRT_API_NOPE()
#define pcu_api_airn_open() EAGLETRT_API_NOPE()
#define pcu_api_airn_close() EAGLETRT_API_NOPE()
#define pcu_api_airn_stop_watchdog() EAGLETRT_API_NOPE()
#define pcu_api_airp_open() EAGLETRT_API_NOPE()
#define pcu_api_airp_close() EAGLETRT_API_NOPE()
#define pcu_api_airp_stop_watchdog() EAGLETRT_API_NOPE()
#define pcu_api_precharge_start() EAGLETRT_API_NOPE()
#define pcu_api_precharge_stop() EAGLETRT_API_NOPE()
#define pcu_api_precharge_stop_watchdog() EAGLETRT_API_NOPE()
#define pcu_api_ams_activate() EAGLETRT_API_NOPE()
#define pcu_api_ams_deactivate() EAGLETRT_API_NOPE()
#define pcu_api_get_precharge_percentage() (0.f)
#define pcu_api_is_precharge_complete() (false)
#define pcu_api_set_state_from_ecu_handle(payload) EAGLETRT_API_NOPE()
#define pcu_api_set_state_from_handcart_handle(payload) EAGLETRT_API_NOPE()
