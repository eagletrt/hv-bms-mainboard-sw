...
#define ERROR_CAN_COMMUNICATION_INSTANCE_COUNT (CAN_COMMUNICATION_NETWORK_COUNT)
...
#define ERROR_ECU_COMMUNICATION_INSTANCE_COUNT (1U)
...
enum ErrorGroup {
    ...
    ERROR_GROUP_ECU_COMMUNICATION,            /*!< ECC communication error */
