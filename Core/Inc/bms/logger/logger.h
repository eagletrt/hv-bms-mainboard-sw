...
enum LoggerLevel {
    ...
    LOGGER_LEVEL_ERROR, /*!< Critical errors requiring immediate attention. */
...
struct LoggerHandler {
    ...
    enum LoggerLevel logger_state;  /*!< Active execution flag: true to process logs, false to mute logging output. */
};
