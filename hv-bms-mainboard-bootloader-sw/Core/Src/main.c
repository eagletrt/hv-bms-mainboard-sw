...
int main(void) {
    ...
    constexpr uint32_t keepalive_interval = 400;
    while (1) {

        BootTask();

        if (HAL_GetTick() - ticks >= keepalive_interval) {
...
static void MX_GPIO_Init(void) {
    ...
    /*Configure GPIO pins : SPARE_4_Pin SPARE_3_Pin SPARE_14_Pin */
    ...
    /*Configure GPIO pins : SPARE_2_Pin SPARE_15_Pin SPARE_1_Pin */
    ...
    /*Configure GPIO pins : SPARE_16_Pin CS_ADC_Pin */
    ...
    /*Configure GPIO pins : LED_1_Pin LED_2_Pin BMS_OK_3V3_Pin NOT_PRECHARGE_Pin
                           AIRN_OFF_Pin AIRP_OFF_Pin */
    ...
    /*Configure GPIO pins : CS_EEPROM_Pin NOT_HOLD_Pin NOT_ADC_INT_Pin SPARE_11_Pin */
    ...
    /*Configure GPIO pins : NOT_EXT_FAULT_LATCHED_MCU_Pin NOT_IMPLAUSIBLE_STATE_LATCHED_MCU_Pin NOT_BMS_FAULT_LATCHED_MCU_Pin NOT_IMD_FAULT_LATCHED_MCU_Pin
                           IMD_CONNECTED_MCU_Pin NOT_LATCH_RESET_MCU_Pin */
    ...
    /*Configure GPIO pins : INDICATOR_CONNECTED_MCU_Pin NOT_IMD_FAULT_COCKPIT_LED_MCU_Pin NOT_BMS_FAULT_COCKPIT_LED_MCU_Pin PLAUSIBLE_STATE_MCU_Pin
                           PLAUSIBLE_STATE_PERSISTED_MCU_Pin TS_LESS_THAN_60V_MCU_Pin PRECH_OPEN_MEC_MCU_Pin */
    ...
    /*Configure GPIO pin : PRECH_CLOSE_COM_MCU_Pin */
    GPIO_InitStruct.Pin = PRECH_CLOSE_COM_MCU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PRECH_CLOSE_COM_MCU_GPIO_Port, &GPIO_InitStruct);

    /*Configure GPIO pins : SPARE_7_Pin SPARE_10_Pin SPARE_8_Pin SPARE_9_Pin */
    ...
    /*Configure GPIO pins : AIRN_CLOSE_COM_MCU_Pin AIRP_CLOSE_COM_MCU_Pin */
