...
void arm_biquad_cascade_stereo_df2T_f16(
    ...
    uint16x8_t reshufenum LedIdxVec;
    uint16_t startIdx = 0;
    ...
    reshufenum LedIdxVec = *(uint16x8_t *)&idx2;
        ...
        *(f16x8_t *)scratch = *(f16x8_t *)pState;
        ...
        while (sample > 0U) {
            ...
            *pOut++ = vgetq_lane(stateVec0, 1);
             ...
             */
            stateVec1 = vldrhq_gather_shifted_offset((float16_t const *)scratch, reshufenum LedIdxVec);
